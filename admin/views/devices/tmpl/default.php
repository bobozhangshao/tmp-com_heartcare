...
<form action="index.php?option=com_heartcare&view=devices" method="post" id="adminForm" name="adminForm">
    ...
    <table class="table table-striped table-hover">
        ...
        <tr>
            ...
            <th width="23%"><?php echo JHtml::_('grid.sort','COM_HEARTCARE_HEALTHDATA_DEVICE_ID','device_id', $listDirn, $listOrder); ?></th>
            <th width="20%"><?php echo JHtml::_('grid.sort','COM_HEARTCARE_HEALTHDATA_DEVICE_TYPE','device_type', $listDirn, $listOrder); ?></th>
            <th width="7%"><?php echo JHtml::_('grid.sort','COM_HEARTCARE_HEALTHDATA_DEVICE_REGISTER_TIME','register_time', $listDirn, $listOrder); ?></th>
            ...
            <th width="20%"><?php echo JHtml::_('grid.sort','COM_HEARTCARE_USER_ID','user_id', $listDirn, $listOrder); ?></th>
        </tr>
        </thead>
